  ...
  return (
    <main className="bg-background text-foreground selection:bg-brand-yellow selection:text-brand-teal relative min-h-screen overflow-hidden py-10 lg:py-16">
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        />
        <div className="bg-brand-yellow/10 absolute top-[10%] left-1/2 size-[500px] -translate-x-1/2 rounded-full blur-[160px]" />
        <div className="bg-brand-teal-light/10 absolute top-[40%] -left-40 size-[400px] rounded-full blur-[160px]" />
      </div>
