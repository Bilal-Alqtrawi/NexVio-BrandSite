...
export default function QuoteComponent() {
  return (
    <section className="relative flex items-center justify-center border-t border-[#80a6af]/10 bg-gradient-to-b from-transparent to-[#1a2e35] px-6 py-28 md:py-40">
      <div className="relative container mx-auto max-w-4xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[48px] border border-[#FFD900]/30 bg-gradient-to-b from-[#1a2e35] to-[#15262c] p-10 text-center shadow-2xl shadow-black/60 backdrop-blur-2xl md:p-20"
        >
          ...
          <div className="relative z-10 mx-auto mt-10 h-1.5 w-16 rounded-full bg-gradient-to-r from-[#FFD900] to-[#67BCD3]" />
        </motion.div>
      </div>
    </section>
  );
